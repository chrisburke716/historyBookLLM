...
class EnvironmentSwitcher:
    ...
    def show_current_environment(self):
        ...
        logger.info(
            f"OpenAI API Key: {'***' if os.getenv('OPENAI_APIKEY') else 'Not set'}"
        )
    ...
    def _test_connection(self, env_name: str) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.info(
                    f"✅ Connected to {env_name} (Books collection may not exist)"
                )
    ...
    def interactive_switch(self):
        ...
        try:
            ...
            env_map = {"1": "production", "2": "development", "3": "test", "0": None}
