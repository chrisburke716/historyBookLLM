...
class LangChainProvider(LLMInterface):
    ...
    def _create_llm(self):
        ...
        try:
            ...
            raise LLMConnectionError(f"Missing dependency for {self.config.provider}: {e}")
    ...
    def _convert_to_langchain_messages(self, messages: List[ChatMessage], context: str | None = None):
